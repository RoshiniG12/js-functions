...
var number1 = 1000;
var number2 = 66;
var number3 = 25; // Step 2: Adding a third variable
var result;
var findTotal;

findTotal = function () {
    result = number1 + number2 + number3; // Step 3: Updating findTotal function
};

findTotal();

console.log(number1 + " + " + number2 + " + " + number3 + " = " + result); // Step 4: Updating console.log
